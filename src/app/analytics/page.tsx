      ...
      <main id="main-content" className="p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="flex items-center justify-between">
              ...
              <Heart className="w-8 h-8 text-optimist-400" />
            </div>
            <div className="flex items-center mt-2 text-green-400 text-sm">
              <TrendingUp className="w-4 h-4 mr-1" />
              +0.8% this month
              ...
              {platformStats.map((stat, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-gradient-to-r from-optimist-500 to-optimist-500 rounded-lg flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            ...
            <div className="text-3xl font-bold text-optimist-400 mb-2">{metrics.totalLikes.toLocaleString()}</div>
