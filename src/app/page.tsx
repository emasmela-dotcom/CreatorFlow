            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto px-6">
              ...
              <div className="mb-10 max-w-2xl mx-auto rounded-2xl border border-sage-500/20 bg-sage-900/20 px-6 py-5">
                ...
                <p className="mt-3 text-sm text-gray-300 leading-relaxed">
                  <strong className="text-white">Create a free account to use AI Coach</strong> — Groq AI runs under AI Coach. Captions and quick tips. No per-word fees. Advanced AI on paid plans shortly.
                </p>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-400">Create an account to use Documents and AI Coach free (Groq under AI Coach). Advanced AI on paid plans shortly.</p>
                </div>
                <div className="text-center">
