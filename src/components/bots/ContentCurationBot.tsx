...
export default function ContentCurationBot({ platform, token }: ContentCurationBotProps) {
  ...
  if (error) {
    return (
      <div className="bg-gradient-to-br from-optimist-900/30 to-optimist-900/30 rounded-lg p-4 border border-optimist-500/30">
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
          ...
          <div className="space-y-2">
            <div className="text-sm font-semibold text-optimist-400">Content Ideas:</div>
    ...
    <div className="bg-gradient-to-br from-optimist-900/30 to-optimist-900/30 rounded-lg p-4 border border-optimist-500/30">
      ...
      {analysis.contentIdeas.length > 0 && (
        <div className="bg-gray-800/50 rounded-lg p-3 mb-4">
          ...
          <div className="text-lg font-bold text-optimist-400 mb-1">
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-optimist-300">{analysis.contentIdeas[0].engagement}</span>
          </div>
      ...
      {/* Expanded Details */}
      {expanded && (
        <div className="space-y-4 pt-4 border-t border-optimist-500/30">
          {/* All Content Ideas */}
                ...
                {analysis.contentIdeas.map((idea, idx) => (
                  <div key={idx} className="bg-gray-800/50 rounded-lg p-3">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-gray-300">•</span>
                      <span className="text-xs text-optimist-300">{idea.engagement}</span>
                    </div>
