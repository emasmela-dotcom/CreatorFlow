      ...
      {isOpen && (
        <>
          <div
            ...
            aria-hidden="true"
          />
          <div className="fixed top-20 left-4 right-4 sm:left-auto sm:right-auto sm:top-24 sm:left-1/2 sm:-translate-x-1/2 z-[200] w-full sm:w-80 max-w-[20rem] rounded-2xl bg-gray-800/95 ring-1 ring-optimist-700 shadow-2xl backdrop-blur">
